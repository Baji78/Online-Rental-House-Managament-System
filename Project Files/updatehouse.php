...
<body>
  ...
  $three="3000";
  $six="6000";
  $query="select * from houses where email='".$a."'";
...
<div class="house">
        ...
        <div class="detailed">
            <a href="delete.php?email=<?php echo $email;?>&description=<?php echo $description; ?>&img1=<?php echo $image;?>">Delete</a>
        </div>
    </div>
    <?php } ?>
</body>
