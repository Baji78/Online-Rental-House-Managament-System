...
<div class="header">
  ...
  <h3 {text-align: center}>RENTER</h3>

</div>

<div class="navbar">
  
<a href="renter.php"><b>Home</b></a>
...
<div class="dropdown">
    ...
    <a href="logout.php" style="float:right;background-color:red;"><b>Logout</b></a>
    <a href="#" style="float:right;background-color:gold;color:black;">Welcome <b><?php echo $a;?></b></a>
